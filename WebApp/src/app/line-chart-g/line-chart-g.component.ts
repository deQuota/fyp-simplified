...
@Component({
  selector: 'app-line-chart-g',
  templateUrl: './line-chart-g.component.html',
  styleUrls: ['./line-chart-g.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class LineChartGComponent implements OnInit {
  ...
  ngOnInit() {
    const legendDiv = document.getElementById('legend-g');
...
plugins: [
    ...
    this.chartistLineChart = new Chartist.Line('.ct-chart-g', this.data, options);
